 ...
 */
public class DkLinearLayout extends LinearLayoutCompat {
	...
	public DkLinearLayout(Context context) {
		super(context);
		init(context);
	}

	public DkLinearLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	@SuppressLint("CustomViewStyleable")
	public DkLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {

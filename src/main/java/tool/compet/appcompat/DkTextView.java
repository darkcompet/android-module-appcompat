 ...
 */
public class DkTextView extends AppCompatTextView {
	...
	public DkTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	@SuppressLint("CustomViewStyleable")
	public DkTextView(Context context, AttributeSet attrs, int defStyleAttr) {

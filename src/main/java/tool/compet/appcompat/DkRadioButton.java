 ...
 */
public class DkRadioButton extends AppCompatRadioButton {
	...
	public DkRadioButton(Context context) {
		super(context);
		init(context);
	}

	public DkRadioButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	@SuppressLint("CustomViewStyleable")
	public DkRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {

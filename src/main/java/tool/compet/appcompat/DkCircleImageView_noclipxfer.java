...
public class DkCircleImageView_noclipxfer extends AppCompatImageView {
	...
	public DkCircleImageView_noclipxfer(@NonNull Context context) {
		super(context);
		init();
	}

	public DkCircleImageView_noclipxfer(@NonNull Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public DkCircleImageView_noclipxfer(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

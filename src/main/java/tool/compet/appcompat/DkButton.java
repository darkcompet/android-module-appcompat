 ...
 */
public class DkButton extends AppCompatButton {
	...
	public DkButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	@SuppressLint("CustomViewStyleable")
	public DkButton(Context context, AttributeSet attrs, int defStyleAttr) {
